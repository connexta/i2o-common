...
/**
 * The <code>BiThrowingConsumer</code> interface expands on the {@link java.util.function.Consumer}
...
public interface BiThrowingConsumer<T, E extends Exception, F extends Exception> {
   ...
   */
  public void accept(T t) throws E, F;
   ...
   * @throws F if an error occurs
   */
  public default BiThrowingConsumer<T, E, F> andThen(BiThrowingConsumer<? super T, E, F> after)
      throws E, F {
    return t -> {
      accept(t);
      after.accept(t);
